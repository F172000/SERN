...
{/* {apiData ? (
        <img src={{base} || avatar} className={style.profile_img} alt="avatar" />
      ) : (
        <p>Loading...</p>
      )} */}
{/* <img src={apiData?.profile ||avatar} className={style.profile_img}  alt="avatar" /> */}
<img src={`data:image/png;base64,${img}`} className={style.profile_img}  alt="avatar" />
{/* <img src={`data:image/png;base64,${apiData.profile}`}></img> */}
